...
@Slf4j
@Singleton
class GoldBarCrafterOverlay extends OverlayPanel
{
	private final Client client;
	private final GoldBarCrafterPlugin plugin;
	private final GoldBarCrafterConfig config;

	String timeFormat;

	@Inject
	private GoldBarCrafterOverlay(final Client client, final GoldBarCrafterPlugin plugin, final GoldBarCrafterConfig config)
	{
		super(plugin);
